...
echo export PATH=$PATH:/usr/local/go/bin:/go/bin > /etc/profile.d/10_gopath.sh
echo export GOROOT=/usr/local/go > /etc/profile.d/10_goroot.sh
echo export GOPATH=/go > /etc/profile.d/20_gopath.sh
chown root:root /etc/profile.d/10_gopath.sh
chown root:root /etc/profile.d/20_gopath.sh
chown root:root /etc/profile.d/10_goroot.sh
